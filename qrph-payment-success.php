...
<body>
        ...
        <div class="wrapper">
            ...
            <form class="form-signin" method="" action="https://qrph-demo.netglobalsolutions.net/">       
              ...
              <!-- <hr> -->
              <center>
              <img src="img/Payment-success.png" class="img-fluid" style="max-width: 80%; height: auto;">
              <!-- <label class="cred">Your about to pay&nbsp;&nbsp;<br> PHP  <span id="total-price2"></span></label><br> -->
              <br>
              <br>
              <br>
              <hr>
              <label class="cred">Transaction ID&nbsp;: 2CIR4JDY8RVQNEE24WE <span class="cred-span"></span></label><br>
              ...
              <label class="cred-amount">--------------------------</label><br>
              <!-- </div> -->
              <label class="cred-amount">Amount Paid &nbsp;  : ₱ <span id="total-price"></span></label><br>
              ...
              <center>
              <button  class="btn btn-lg btn-primary btn-block btn-next" type="submit">Back Home</button>
              </center>
              <hr>
              <center>
              ...
              <script>
                            ...
                            // document.getElementById("total-price2").innerHTML = prePay+".00";
