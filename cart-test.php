...
<head>
    ...
    <style>
        .grid-striped  {
         ...
         .head{
            background-color: rgba(22, 20, 20, 0.364);
         }
         .products{
            width: 45%;
            display: flex;
...
<body>
    ...
    <!-- cart display -->
        ...
        <div class="container product-containers grid-striped ">           
        ...
        <div class="row basket">
            <div class="col-5"><a class="btn btn-success" href="<?php echo $base_url;?>/checkout.php" role="button">Checkout</a></div>
            <!-- <div class="col-2"></div> -->
            
            <div class="col-4"></div>
            <div class="col-3"><b>TOTAL PRICE: ₱ </b><span id="totalprice"></span> </div>
        ...
        <script>
             ...
             document.getElementById("totalprice").innerHTML = cartCost+".00";
        </script>
                ...
                <ul class="list-unstyled templatemo-accordion">
                    <li class="pb-3">
                        ...
                        <ul class="collapse show list-unstyled pl-3">
                            ...
                            <li><a class="text-decoration-none" href="#">Razer</a></li>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <ul class="list-inline shop-top-menu pb-3 pt-1">
                            ...
                            <li class="list-inline-item">
                                <a class="h3 text-dark text-decoration-none mr-3" href="#">Laptops</a>
                            </li>
                            <li class="list-inline-item">
                                <a class="h3 text-dark text-decoration-none" href="#">Tablets</a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            ...
                            <div class="card-body">
                                <center><a href="shop-single.html" class="h3 text-decoration-none">HP EliteBook 840 G3</a></center>
                        ...
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                ...
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                    <ul class="list-unstyled">
                                        <li><a class="btn btn-success text-white" href="shop-single.html"><i class="far fa-heart"></i></a></li>
                                        <li><a class="btn btn-success text-white mt-2" href="shop-single/shop-single-asus.html"><i class="far fa-eye"></i></a></li>
                                        <li><a class="add-cart btn btn-success text-white mt-2" href="#"><i class="fas fa-cart-plus"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="card-body">
                                <center><a href="shop-single.html" class="h3 text-decoration-none">ASUS VivoBook 15 X515</a></center>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                    <li></li>
                                    <li class="pt-2">
                                        <span class="product-color-dot color-dot-red float-left rounded-circle ml-1"></span>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            ...
                            <div class="card-body">
                               <center> <a href="shop-single.html" class="h3 text-decoration-none">Dell Latitude 7280</a></center>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                    <li></li>
                                    <li class="pt-2">
                                        <span class="product-color-dot color-dot-red float-left rounded-circle ml-1"></span>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            ...
                            <div class="card-body">
                            <center><a href="shop-single.html" class="h3 text-decoration-none">Lenovo ThinkPad T15 Gen 2</a></center>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                    <li></li>
                                    <li class="pt-2">
                                        <span class="product-color-dot color-dot-red float-left rounded-circle ml-1"></span>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            ...
                            <div class="card-body">
                                <center><a href="shop-single.html" class="h3 text-decoration-none">Huawei MateBook D 14</a></center>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                    <li></li>
                                    <li class="pt-2">
                                        <span class="product-color-dot color-dot-red float-left rounded-circle ml-1"></span>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            ...
                            <div class="card-body">
                                <center><a href="shop-single.html" class="h3 text-decoration-none">MSI Titan GT77</a></center>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                    <li></li>
                                    <li class="pt-2">
                                        <span class="product-color-dot color-dot-red float-left rounded-circle ml-1"></span>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            ...
                            <div class="card-body">
                                <center><a href="shop-single.html" class="h3 text-decoration-none">Razer Blade 14</a></center>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                    <li></li>
                                    <li class="pt-2">
                                        <span class="product-color-dot color-dot-red float-left rounded-circle ml-1"></span>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            ...
                            <div class="card-body">
                            <center><a href="shop-single.html" class="h3 text-decoration-none">Toshiba Satellite S55</a></center>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                    <li></li>
                                    <li class="pt-2">
                                        <span class="product-color-dot color-dot-red float-left rounded-circle ml-1"></span>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img class="card-img rounded-0 img-fluid" src="assets/img/Lg1.jpg">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                    <ul class="list-unstyled">
                                        <li><a class="btn btn-success text-white" href="shop-single.html"><i class="far fa-heart"></i></a></li>
                                        <li><a class="btn btn-success text-white mt-2" href="shop-single.html"><i class="far fa-eye"></i></a></li>
                            ...
                            <div class="card-body">
                            <center><a href="shop-single.html" class="h3 text-decoration-none">LG Gram 17</a></center>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                    <li></li>
                                    <li class="pt-2">
                                        <span class="product-color-dot color-dot-red float-left rounded-circle ml-1"></span>
                                ...
                                <p class="text-center mb-0">₱31,500.00</p>
                            </div>
                        </div>
                    </div>
                </div>
