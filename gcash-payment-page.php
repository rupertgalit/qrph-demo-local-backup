...
<body>
        ...
        <div class="wrapper">
            ...
            <form class="form-signin" method="" action="<?php echo $base_url;?>/gcash-payment-success.php">       
              ...
              <br>
              <hr>
              <label class="cred">Merchant&nbsp;: NETGLOBAL <span class="cred-span"></span></label>
              ...
              <center>
              <button  class="btn btn-lg btn-primary btn-block btn-next" type="submit">Pay</button>
              </center>
              <hr>
              <center>
